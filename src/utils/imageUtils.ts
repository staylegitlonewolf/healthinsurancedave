...
export const IMAGES = {
  ...
  CERT_SOUTH_CAROLINA: getImagePath('media/Certification/South Carolina.png'),
  ...
  // PDFs
  PDF_ALABAMA: getImagePath('media/Certification/Alabama_pdf.pdf'),
  ...
  PDF_SOUTH_CAROLINA: getImagePath('media/Certification/South Carolina_pdf.pdf'),
