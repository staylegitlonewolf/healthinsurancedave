      ...
      <div className="admin-content">
          ...
          <div className="overview-tab">
            ...
            <div className="quick-actions">
              ...
              <div className="action-buttons">
                ...
                <button className="action-btn">Add Blog Post</button>
        ...
        {activeTab === 'blog' && (
          <div className="blog-tab">
            <h3>Blog & Video Management</h3>
            <div className="content-controls">
              <button className="add-blog-btn">+ New Blog Post</button>
              <button className="add-video-btn">+ Upload Video</button>
            </div>
            <div className="content-list">
              <div className="content-item">
                <h4>Five Simple Tips for Effective Event Budgeting</h4>
                <p>Published: Dec 1, 2024 • Views: 156</p>
                <div className="content-actions">
                  <button className="edit-content-btn">Edit</button>
                  <button className="view-content-btn">View</button>
                </div>
              </div>
              <div className="content-item">
                <h4>Best Gifts To Give For A Bar/Bat Mitzvah</h4>
                <p>Published: Nov 28, 2024 • Views: 89</p>
                <div className="content-actions">
                  <button className="edit-content-btn">Edit</button>
                  <button className="view-content-btn">View</button>
                </div>
